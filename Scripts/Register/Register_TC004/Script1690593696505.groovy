...
def alert_Text = WebUI.getText(findTestObject('Register Page Kasir Aja/Verify/div_password is not allowed to be empty'))

//log.logInfo(Berhasil_Text)
WebUI.verifyElementVisible(findTestObject('Register Page Kasir Aja/Verify/div_password is not allowed to be empty'))

WebUI.verifyMatch(alert_Text, '^"password" is not allowed to be empty.*', true)
