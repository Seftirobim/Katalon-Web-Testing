...
def alert_Text = WebUI.getText(findTestObject('Register Page Kasir Aja/Verify/div_name is not allowed to be empty'))

//log.logInfo(Berhasil_Text)
WebUI.verifyElementVisible(findTestObject('Register Page Kasir Aja/Verify/div_name is not allowed to be empty'))

WebUI.verifyMatch(alert_Text, '^"name" is not allowed to be empty.*', true)
